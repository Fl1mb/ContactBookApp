...
Q_CONSTINIT static const uint qt_meta_data_CLASSApplicationENDCLASS[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void,
    QMetaType::Void, 0x80000000 | 4, 0x80000000 | 4,   11,   12,
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->MakeQuery((*reinterpret_cast< std::add_pointer_t<Person>>(_a[1]))); break;
        case 2: _t->DeleteHuman((*reinterpret_cast< std::add_pointer_t<Human*>>(_a[1]))); break;
        case 3: _t->CloseWindow(); break;
        case 4: _t->Edit((*reinterpret_cast< std::add_pointer_t<Person>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<Person>>(_a[2]))); break;
        default: ;
        }
