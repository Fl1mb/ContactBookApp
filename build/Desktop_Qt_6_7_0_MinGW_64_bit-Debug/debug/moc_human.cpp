...
Q_CONSTINIT const QMetaObject Human::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSHumanENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<Human *, std::false_type>,
        // method 'EditHuman'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void Human::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->DeleteThis((*reinterpret_cast< std::add_pointer_t<Human*>>(_a[1]))); break;
        case 1: _t->EditHuman((*reinterpret_cast< std::add_pointer_t<Person>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<Person>>(_a[2]))); break;
        case 2: _t->OpenInfo(); break;
        case 3: _t->CloseInfo(); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType(); break;
            case 0:
                *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType::fromType< Human* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (Human::*)(Human * );
            if (_t _q_method = &Human::DeleteThis; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Human::*)(const Person & , const Person & );
            if (_t _q_method = &Human::EditHuman; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Human::DeleteThis(Human * _t1)
{
...
// SIGNAL 1
void Human::EditHuman(const Person & _t1, const Person & _t2)
{
